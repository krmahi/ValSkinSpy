    ...
    return ft.Container(
        ...
        content=ft.Row(
            [
                ...
                ft.Row([ft.Image(src="images/VP.png", width=24, height=24), ft.Text(f"{vp:,}", size=18, weight="bold", color="#fbbf24")]),
                ft.Container(width=15),
                ft.Row([ft.Image(src="images/RP.png", width=24, height=24), ft.Text(f"{rp:,}", size=18, weight="bold", color="#38bdf8")]),
                ft.Container(width=15),
                ft.Row([ft.Image(src="images/KC.png", width=24, height=24), ft.Text(f"{kc:,}", size=18, weight="bold", color="#a78bfa")]),
            ],
